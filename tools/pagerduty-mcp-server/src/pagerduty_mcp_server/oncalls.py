...
def list_oncalls(*,
                current_user_context: Optional[bool] = None,
    ...
    if current_user_context is True and user_ids is not None:
        raise ValueError("Cannot use current_user_context with user_ids")
